...
int fastAlignmentRoutine(const char* seq1, const char* seq2, const char* qual2, int len1, int len2, int gapextend, int nucprior,
			 const char* homopolgapq_or_localgapopen, char usehomopolgapq, char* aln1, char* aln2) {
  ...
  for (; s<2*(len2+8-1 + 1); s+=2) {
    ...
    /*
    printxmm("gapopen   ",_gap_open);
    printxmm("mat_even",_m1);
    printxmm("mat_odd ",_m2);
    printxmm("ins_odd ",_i2);
    printxmm("del_odd ",_d2);
    */
    ...
    printxmm("mat_odd ",_m2);
    printxmm("mat_even",_m1);
    printxmm("ins_even ",_i1);
    printxmm("del_even ",_d1);
    */
